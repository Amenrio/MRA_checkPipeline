...
import MRA_orientPipeline_v01 as ORP
import MRA_namingPipeline_v01 as NMP
...
def MRA_checkPipeline():
    ...
    cmds.text("Check Orient in Joints",align="center",
                                ...
                                font = "boldLabelFont")
    cmds.separator( style = 'none' , height = 10 )
    cmds.button(label="Check Orient Pipeline",h=40, c = ORP.checkOrient,bgc = [0.682,0.616,0.851])
    ...
    cmds.text("Pipeline Animacion",align="center",
                                ...
                                font = "boldLabelFont")
    cmds.separator( style = 'none' , height = 10 )
    cmds.button(label="Check Naming Pipeline",h=40, c = NMP.check_naming_pipeline,bgc = [0.682,0.616,0.851])
    cmds.separator( style = 'none' , height = 10 )
