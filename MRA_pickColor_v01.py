...
def run():
	...
	cmds.window('UIcolorOverride' , widthHeight = (200,400),resizeToFitChildren = True, title = 'Color Override',mnb = False, mxb = False)
	cmds.frameLayout('Color Override')
	colorWheel = cmds.colorInputWidgetGrp( label='Color', rgb=(0, 1, 0) )
