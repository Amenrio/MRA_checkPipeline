...
def MRA_OPUI(object):
    ...
    ventanaUI = cmds.window('MRA_OPUI' ,t="MRA Check Orient Joints",rtf=True,s=True,mnb=False,mxb=False)
    ...
    if len(object) > 0:
        ...
        cmds.text(label="    No se encontraron orientaciones en los joints    ",align="center",h=30,bgc=[0.1,1,0.1], fn = "boldLabelFont")
